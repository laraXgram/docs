...
> [!NOTE]
> If you are interested in rate limiting incoming HTTP requests, please consult the [rate limiter middleware documentation](https://github.com/laraXgram/docs/blob/markdown/listening.md#rate-limiting).
