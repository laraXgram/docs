...
You should also add the `deleted_at` column to your database table. The LaraGram [schema builder](/docs/{{version}}/migrations) contains a helper method to create this column:
