...
Within this closure, you may define the processes that belong to the pool. Once a process pool is started via the `start` method, you may access the [collection](https://github.com/laraXgram/docs/blob/markdown/collections.md) of running processes via the `running` method:
